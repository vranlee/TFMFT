...
from models import Multi_Tracker, save_track
...
def get_args_parser():
    ...
    # appended for track.
    parser.add_argument('--track_train_split', default='train', type=str, help='Dataset split for training the tracker')
    parser.add_argument('--track_eval_split', default='val', type=str, help='Dataset split for evaluating the tracker')
    parser.add_argument('--track_thresh', default=0.4, type=float, help='Threshold for tracking confidence')
    parser.add_argument('--reid_shared', default=False, type=bool, help='Whether to use shared features for ReID')
    parser.add_argument('--reid_dim', default=128, type=int, help='Dimensionality of the ReID features')
    parser.add_argument('--num_ids', default=360, type=int, help='Number of unique IDs for ReID')
    
    # Detector for tracking
    parser.add_argument('--det_val', default=False, action='store_true', help='Use detector for validation in tracking')

    # FP16
    parser.add_argument('--fp16', default=False, action='store_true', help='Use FP16 precision during training')
...
def main(args):
    ...
    if args.eval:
        ...
        tracker = Multi_Tracker(score_thresh=args.track_thresh)
